...
import MemberHistoryInfo from './pages/mypage/MemberHisotryInfo';
    ...
    <AuthProvider>
        <Router>
          <Routes>
              ...
              <Route path="/history/info" element={<MemberHistoryInfo/>}/>
              ...
              <Route path="/admin/:alertId" element={<ProtectedRoute element={<SendAlertInfo/>}/>}/>
